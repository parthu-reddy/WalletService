...
@AutoConfigureStubRunner(ids = "com.fooddelivery:payment-service:+:stubs", stubsMode = StubRunnerProperties.StubsMode.LOCAL)
@EmbeddedKafka(partitions = 1)
public class TopupEventConsumerTest {
    ...
    public void testConsumerIsWorking() {
        try {
            stubTrigger.trigger("trigger-payment-success");
        } catch (Exception e) {
